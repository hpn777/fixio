...
exports.FIXSession = function (fixClient, isAcceptor, options) {
    ...
    var isAuthenticFunc = _.isUndefined(options.isAuthenticFunc) ? function () {
        return true;
    } : options.isAuthenticFunc;
    ...
    this.logToFile = function (raw) {
        if (file === null) {
            ...
            file = fs.createWriteStream(this.logfilename, {
                'flags': 'a',
                'mode': 0666
            });
    ...
    this.send = function (msg, replay) {
        ...
        var outmsg = fixutil.convertToFIX(msg, fixVersion, fixutil.getUTCTimeStamp(),
            senderCompID, targetCompID, outgoingSeqNum, {
